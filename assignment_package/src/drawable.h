...
protected:
    ...
    bool m_idxGeneratedOpq;
    bool m_idxGeneratedTra;
    ...
    bool m_interleavedGeneratedOpq;
    bool m_interleavedGeneratedTra;
...
public:
    ...
    void generateInterleavedOpq();
    void generateInterleavedTra();
    void generateUV();
